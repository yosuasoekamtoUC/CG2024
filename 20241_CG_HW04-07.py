...
screen = pygame.display.set_mode((width, height), 0, 32)
pygame.display.set_caption("20235164-CompGraphHW04-HW07")
...
selectedPoint = -1
lagrangeButton = button((230,230,230),50,100,100,50,"4. Lagrange")
bezierButton = button((230,230,230),50,200,100,50,"5. Bezier")
hermiteButton = button((230,230,230),50,300,100,50,"6. Hermite")
cubicSplineButton = button((230,230,230),50,400,100,50,"7. Cubic Spline")
